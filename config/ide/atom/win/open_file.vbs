...
'   open_file.vbs "atm://open?url=file://<path_to_file>&line=4"

' path to atom.exe
Dim atom_path

' >>> EDIT THIS PATH TO MATCH YOUR ATOM INSTALL PATH / OR PATH TO ATOM PORTABLE <<<
atom_path = "C:\PortableApps\MyApps\atom\app\atom.exe"
...
' Final command
Dim run_command
run_command = """"&atom_path&""" """&file_name&":"&line&""""
